...
```{r, fig.width = 7, fig.asp = .5}
plot_mult(AR_1, forecast1 = DL_Flaw1, title = "Test")
plot_mult(MA_1, forecast1 =DL_Flaw2, title ="Test")
plot_mult(ARMA_1, forecast1 = DL_Flaw3,title = "Test")
```
...
data_mon %>%
  ...
  filter((abs(temp) < 50) & (20000101 <= date) ) %>% 
