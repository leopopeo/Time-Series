...
Wie man erkennen kann, kann der Durbin-Levinson Algorithmus bereits mit wenigen Inputs sehr gute Vorhersagen treffen, die man insbesondere am AR(1) und ARMA(1) erkennt, was in der Theorie auch übereinstimmt. Auffallend ist außerdem, dass der Durbin-Levinson Algorithmus auch bei unserer MA-Zeitreihe auch sehr passable Vorhersagen erstellt, wofür eigentlich der Innovation besser funktionieren sollte. Außerdem verringert sich die Ungenauigkeit des Algorithmus je mehr Input dieser bekommt, was schön zu erkennen ist, da bereits bei 60+ die Vorhersage fast exakt mit der Zeitreihe übereinstimmt.
...
```
Für die Übersichtlichkeit wird hier einmal für die simultieren AR(2)-, MA(2)- und  ARMA(1,1)-Zeitreehen die Vorhersage durch den Durbin-Levinson- und durch den Innovation-Algorithmus gegenüber gestellt:
