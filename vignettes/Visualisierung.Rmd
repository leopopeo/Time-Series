...
```
Hier haben wir leider nicht das gewünsche Ergbenis erhalten. In der Dokumentation der *forecast*-Funktion steht zwar, das die Funktion ebenfalls den gleichen Innovatoin Algorithmus als Grundlage für die Berechnung benutzt, es ist jedoch trotzdem keine gute Übereinstimmung zwischen unseren Plots und den *forecast*-Plots zu erkennen. Die Spezifizierung des ARMA-Modells in der *forecast*-Funktion weicht hier vom generierten Prozess ab, jedoch wird das Ergebnis der forecast-Funktion mit anderen Werten für *p* und *q*  noch schlechter. 
