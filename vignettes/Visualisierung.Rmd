...
Nun simulieren wir uns Daten mit verschiedenen Eigenschaften und beobachten, welche Auswirkungen die $\phi$ und $\theta$ bei gleichbleibender Stichprobengröße haben und für welche Zeitreihen der DLA akkurat ist.
...
Um nun die Genauigkeit vom Durbin-Levinson Algorithmus überprüfen zu können, verwenden wir hierfür eine Plotfunktion, um die ursprüngliche Zeitreihe und die Vorhersage von Durbin-Levinson Algorithmus vergleichen zu können.
