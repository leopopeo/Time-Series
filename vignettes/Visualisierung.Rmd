...
innovation_prediction <- function(X){
   ...
   for(i in 10:length(X)){
     inno_help <- X[1:i]
     inno_prediction[i+1-100] <- ts_predict(inno_help,1)
   }
   inno_prediction
}
```
...
innovation_sim_MS_2 <- innovation_prediction(MA_2)
...
plot_inno(MA_2, innovation_sim_MS_2, "MA")
plot_inno(ARMA_1, innovation_sim_ARMA1, "ARMA")
```
